...
export default function MapPage() {
  ...
  return <main className="relative h-[calc(100vh-4rem)] min-h-[42rem] overflow-hidden">
    ...
    <div className="pointer-events-none absolute inset-0 p-4 sm:p-6">
      ...
      <div className="pointer-events-auto absolute left-1/2 top-5 hidden -translate-x-1/2 rounded-2xl border border-white/10 bg-[#111113]/90 px-4 py-2 text-center backdrop-blur md:block"><BlurText as="h1" text="Live Flood Map" delay={140} className="text-sm font-semibold" /><p className="mt-1 text-[10px] text-zinc-400"><i className="mr-1.5 inline-block size-1.5 rounded-full bg-emerald-400" />{modeLabel}</p></div>
