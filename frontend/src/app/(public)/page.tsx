...
const steps = [
  ["01", "Report", "Share a flood, blocked drain, or road condition in seconds."],
  ["02", "Verify", "AI and community signals help separate noise from usable information."],
  ["03", "Navigate", "Choose a route that respects what is happening on the ground."],
] as const;
...
export default function PublicLandingPage() {
  ...
  return <main data-scroll-reveal-page className="overflow-hidden bg-[#09090b] text-zinc-50">
    <section id="overview" className="mesh relative border-b border-white/[.06] px-5 pt-20 sm:pt-28">
      <div className="dot-grid pointer-events-none absolute inset-x-0 top-0 h-[30rem] opacity-40" />
      <div className="relative mx-auto max-w-5xl text-center">
        <Reveal delay={0.02}>
          <p className="mx-auto inline-flex items-center gap-2 rounded-full border border-blue-400/25 bg-blue-500/10 px-3 py-1.5 text-[11px] font-medium text-blue-300"><span className="size-1.5 rounded-full bg-emerald-400 shadow-[0_0_10px_#34d399]" />{modeMessage}</p>
        </Reveal>
        <Reveal delay={0.1}>
          <h1 className="mx-auto mt-6 max-w-3xl text-5xl font-semibold leading-[.98] tracking-[-.06em] sm:text-7xl">Know before <span className="bg-gradient-to-r from-blue-300 to-cyan-400 bg-clip-text text-transparent">you</span> go.</h1>
        </Reveal>
        <Reveal delay={0.18}>
