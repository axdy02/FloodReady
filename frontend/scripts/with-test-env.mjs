...
const names = ["FRONTEND_ENV", "NEXT_PUBLIC_API_BASE_URL", "INTERNAL_API_BASE_URL", "NEXT_PUBLIC_APP_ORIGIN", "NEXT_PUBLIC_ALLOW_INSECURE_PUBLIC_HTTP", "NEXT_PUBLIC_CARTO_BASEMAP_KEY", "NEXT_PUBLIC_MAP_STYLE_URL", "NEXT_PUBLIC_MAP_ATTRIBUTION", "NEXT_PUBLIC_MAP_CONNECT_ORIGINS", "NEXT_PUBLIC_MAP_IMAGE_ORIGINS", "NEXT_PUBLIC_DEFAULT_MAP_LATITUDE", "NEXT_PUBLIC_DEFAULT_MAP_LONGITUDE", "NEXT_PUBLIC_DEFAULT_MAP_ZOOM", "NEXT_PUBLIC_MAX_UPLOAD_SIZE_MB"];
const unsupported = /[\r\n\0#$\\"]/u;
